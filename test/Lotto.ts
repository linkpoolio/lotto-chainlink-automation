...
describe("Lotto", function () {
  let owner: any, vrfCoordinator: any, subscriptionId: any, requestConfirmations: any, callbackGasLimit: any, keyHash: any;
  let lotto: any;
  beforeEach(async () => {
  ...
  describe("User Actions", function () {
    it("Should revert for closed lotto", async function () {
      await expect(lotto.enterLotto({numbers:[],requestId: 0}, true)).to.be.revertedWith("Lotto is not live");
    });
